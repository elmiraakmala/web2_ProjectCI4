...
(4, '2023-07-08-075439', 'App\\Database\\Migrations\\Tambahkategorigroupproduk', 'default', 'App', 1688803040, 3);
...
CREATE TABLE `table_product` (
  ...
  `kategorigroupproduk` varchar(25) DEFAULT NULL,
  `hargabeliproduk` int(7) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `table_product` (`id`, `product_name`, `stock`, `price`, `created_at`, `updated_at`, `kategorigroupproduk`, `hargabeliproduk`) VALUES
(16, 'payung transparan', 20, 25000, '2023-07-08 08:35:53', '2023-07-08 08:35:53', 'payung ', 25000),
(18, 'baju merah', 5, 20000, '2023-07-08 08:38:04', '2023-07-08 08:38:04', 'pakaian', 20000);
